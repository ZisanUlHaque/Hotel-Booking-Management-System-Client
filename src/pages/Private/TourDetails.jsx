// src/pages/Private/TourDetails.jsx
...
const TourDetails = () => {
  ...
  // Booking Handler with SweetAlert
  const handleBooking = async () => {
    ...
    if (!selectedDate) {
      Swal.fire({
        icon: "warning",
        title: "Select a date",
        text: "Please select your travel date before booking.",
      });
      return;
    }
    ...
    const bookingData = {
      ...
      // Booking details
      travelDate: selectedDate.toISOString().split("T")[0], // yyyy-mm-dd
      guests: guests,
      ...
      discountAmount:
        tour.discount > 0
          ? Math.round((totalPrice * tour.discount) / 100)
          : 0,
    ...
    try {
      ...
      if (res.data.insertedId || res.data.acknowledged) {
        Swal.fire({
          ...
          text: "You can complete payment from your dashboard.",
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-gray-50 rounded-xl">
                  ...
                  <p className="font-bold text-gray-800">
                    {tour.languages?.length || 2} Available
                  </p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-xl">
              ...
              {tour.highlights?.length > 4 && (
                ...
                >
                  {showAllHighlights ? (
                    ...
                    <>
                      Show All {tour.highlights.length} Highlights{" "}
                      <FaChevronDown />
                    </>
                  )}
                </button>
                  ...
                  {tour.itinerary.map((day) => (
                    ...
                    >
                      <button
                        onClick={() =>
                          setActiveDay(
                            activeDay === day.day ? null : day.day
                          )
                        }
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">
                      {tour.tourGuide.experience} Experience
                    </p>
                    <div className="flex items-center gap-1 mt-1">
                      <FaStar className="text-yellow-500" />
                      <span className="font-bold">
                        {tour.tourGuide.rating}
                      </span>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 shadow-lg sticky top-6">
              ...
              <button
                ...
                className={`w-full py-4 font-bold text-lg rounded-xl mb-3 transition
              ...
              {/* Contact */}
              <button className="w-full py-3 border-2 border-primary text-primary font-medium rounded-xl hover:bg-primary/5 transition">
