      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
          ...
          <p className="text-xs md:text-sm text-slate-400 max-w-sm">
            Swipe through popular spots travelers are booking right now – tap a
            card on desktop to pause.
          </p>
        </div>
        ...
        <div className="relative mb-4">
          ...
          <div className="marquee-row flex items-center gap-4">
        ...
        <div className="relative">
          ...
          <div className="marquee-row-reverse flex items-center gap-4">
